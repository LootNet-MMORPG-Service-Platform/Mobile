  ...
  const renderSellItem = (item) => (
    ...
    >
      ...
      <View style={styles.sellItemBody}>
        <Text style={[styles.sellItemName, selectedItemId === item.id && styles.sellItemNameSelected]}>
          {item.name}
        </Text>
        <Text style={[styles.sellItemMeta, selectedItemId === item.id && styles.sellItemMetaSelected]}>
  ...
  return (
    ...
    >
      ...
      <View style={styles.modeSwitch}>
        ...
        >
          <Text style={[styles.modeButtonText, activeMode === 'buy' && styles.modeButtonTextActive]}>
            Buy
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.modeButtonText, activeMode === 'sell' && styles.modeButtonTextActive]}>
            Sell
          </Text>
        </TouchableOpacity>
      </View>
        ...
        <>
          <View style={styles.filterRow}>
            {CATEGORY_OPTIONS.map((option) => (
              <TouchableOpacity
                key={option.label}
                style={[styles.filterButton, category === option.value && styles.filterButtonActive]}
                onPress={() => setCategory(option.value)}
              >
                <Text style={[styles.filterText, category === option.value && styles.filterTextActive]}>
                  {option.label}
                </Text>
              </TouchableOpacity>
            ))}
